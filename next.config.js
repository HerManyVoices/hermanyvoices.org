...
module.exports = {
  ...
  env: { 
    ...
    ADDEVENT_PAST_MAIN_EVENTS_ENDPOINT1: [ process.env.ADDEVENT_PAST_MAIN_EVENTS_ENDPOINT1 ],
    ADDEVENT_PAST_MAIN_EVENTS_ENDPOINT2: [ process.env.ADDEVENT_PAST_MAIN_EVENTS_ENDPOINT2 ],
