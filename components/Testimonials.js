    ...
    <div className="container mx-auto px-4">
      <div className="max-w-6xl p-4 flex flex-wrap justify-center items-center">
        <div className="mb-6 w-full lg:w-1/3 text-center">
          <img className="mb-6 mx-auto w-32 h-32 rounded-full object-cover" src="https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1055&amp;q=80" alt=""></img>
          <h4 className="text-xl">Ian Brown</h4>
          <p className="text-green-600">Head of Development</p>
        </div>
        <div className="w-full lg:w-2/3">
          <svg className="mb-4 text-green-600 h-10" viewBox="0 0 32 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h3 className="mb-6 text-3xl lg:text-4xl font-bold font-heading">Maecenas nibh purus, pharetra ac felis sed, elementum molestie urna. Nunc at arcu non ipsum.</h3>
          <div>
