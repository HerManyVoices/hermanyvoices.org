                ...
                <NavigationMenu.Root className="sticky top-0 z-50" orientation="vertical">
                    <NavigationMenu.List className="flex items-center justify-center bg-gray-50 px-6 py-2">
                        ...
                        <NavigationMenu.Item className="mx-2">
                            ...
                            <NavigationMenu.Content className="absolute overflow-hidden rounded-lg shadow-lg ring-1 ring-purple-500 ring-opacity-5">
                            <div className="grid gap-8 bg-white p-7">
                                    <NextLink href="/earth-day#speaker-submission" className="-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-50 text-start">
                                        <SpeakerIcon aria-hidden="true" />
                                        <div className='max-w-[240px]'>
                                            <p className="text-sm font-medium text-gray-900">Call for Speakers</p>
                                            <p className="text-sm text-gray-600">
                                                Submit your talk for Earth Day 2023
                                            </p>
                                        </div>
                                    </NextLink>
                                </div>
