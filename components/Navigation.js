...
const handleToggle = () => {
  ...
  return (
    <div>
      <nav
        className="relative flex items-center justify-between bg-gray-50 px-6 py-6"
      >
        ...
        <div className="lg:hidden">
          <button onClick={handleToggle} className="flex items-center p-3 text-gray-400">
            <svg
      ...
      {/* begin mobile nav bar,  "hidden class triggers open/close" */}
      {isOpen && <div
        className="navbar-menu fixed top-0 left-0 bottom-0 z-50 w-5/6 max-w-sm"
      >
