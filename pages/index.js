        ...
        <div className="my-12">
          <div className="-mx-4 -mb-4 flex flex-wrap md:mb-0">
            <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
              ...
              <p className="mx-4 text-blueGray-400 mb-2 text-lg leading-relaxed">
                Her Many Voices Foundation is a passionate group of
                activists/artivists intent on saving our Mother Earth and All
                Her Children, through big acts of love and service, disguised as
                a non-profit.
              </p>
            </div>
            <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
            ...
            <div className="radius-for-skewed bg-green-600 py-20">
              ...
              <div className="my-12">
            <div className="-mx-4 -mb-4 flex flex-wrap-reverse md:mb-0">
              <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
                <img
              ...
              <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
                ...
                <p className="mx-4 text-blueGray-400 mb-2 leading-relaxed">
                  Can you hear it? The Voice of Mother Earth Calling? Her
                  children Crying? Are you listening? She’s weeping… and we are
                  listening, and responding.
                </p>
                <p className="mx-4 text-blueGray-400 mb-2 leading-relaxed">
                  85% of women and children live in poverty. 75% of the earth’s
                  landscape is scared by environmental calamity. Children are
                  hungry. People are desperate. Time is running out.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="-mx-4 -mb-4 flex flex-wrap md:mb-0">
            <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
              <h2 className="mx-4 mb-4 font-heading text-3xl font-bold md:text-4xl">
              We are responding. <span className="text-green-600">Why we succeed:</span>
              </h2>
              <p className="mx-4 text-blueGray-400 mb-2 text-lg leading-relaxed">
              Adaptability in approach / focus on artivism and Indigenous Wisdom / Partner and Coalition Building
              </p>
            </div>
            <div className="mb-4 w-full px-4 md:mb-0 md:w-1/2">
              <img
